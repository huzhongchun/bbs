...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = 'rdszk45dx2t84cq9su67.mysql.rds.aliyuncs.com:3306';
$_config['db']['1']['dbuser'] = 'h5_dba';
$_config['db']['1']['dbpw'] = 'h5_dba';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'bbs';
$_config['db']['1']['tablepre'] = 'taoo_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'Di2DHX_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'cgs0_';
$_config['cookie']['cookiedomain'] = 'bbs.biyeyuan.com';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'a23a04VgLVzpwEWR';

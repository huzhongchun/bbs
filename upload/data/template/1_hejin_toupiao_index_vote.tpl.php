...
<head>
    ...
    <meta name="description" content="<?php echo stripslashes($vote['content']);?>v25">
...
<section class="content" id="get_info" data-rid="503" data-sort="" data-kw="" data-page="">
    <div class="text_a clearfix" id="sort">
        ...
        <a href="<?php echo HEJIN_URL;?>&model=<?php echo $phmodel;?>&vid=<?php echo $vote['id'];?>" >投票排行</a>
        ...
        <?php if(is_array($zuopins)) foreach($zuopins as $zuopin) { ?>                      <li class="picCon">
                        <div>
                            ...
                            <div class="clearfix">
                                ...
                                <a href="" class="vote" data-itid="<?php echo $zuopin['id'];?>" data-vote_num="<?php echo $vote['id'];?>" data-rule_id="<?php echo $vote['id'];?>">投票</a>
                            </div>
                        </div>
                    </li>
                   <?php } ?> 
...
<?php } ?>  
<div style="display:none"><?php echo $hejintoupiao['hjtp_dsftjdm'];?>v25</div></body>
</html>